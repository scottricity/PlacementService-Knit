...
type Signal = {Fire: (...any?) -> (...any?), Connect: (...any?) -> (...any?)}
...
local function PLACEMENT(self, Function: Signal, callback:() -> ()?)
	...
	if not Function:Fire(objectName, placedObjects, self.Prefabs, cf, plot) then return end	
...
function PlacementInfo:requestPlacement(func: Signal, callback: (...any?) -> ())
